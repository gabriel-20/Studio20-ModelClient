...
public class Global {
    ...
    public static final String LOGIN_URL = "https://api.studio20.group/api/testlogin";
    public static final String RANDOM_MODELS = "https://api.studio20.group/api/randommodels";

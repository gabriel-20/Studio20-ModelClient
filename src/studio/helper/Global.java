...
public class Global {
    ...
    public static final String JASMIN_EXE_NAME = "jcam.exe";
    public static final String AVATAR = "http://planetbotanix.com/wp-content/uploads/2017/08/Female-Avatar-1-300x300.jpg";
